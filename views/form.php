    ...
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-md-9 radioset">
                <input type="radio" name="enabled" id="enabledyes" value="1" <?php echo (returnontransfer_get('enabled')==="true")?"CHECKED":""?>>
                <label for="enabledyes"><?php echo _("Yes");?></label>
                <input type="radio" name="enabled" id="enabledno" value="" <?php echo (returnontransfer_get('enabled')==="true")?"":"CHECKED"?>>
...
<div class="element-container">
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="number" min="5" max="60" class="form-control" id="timeout" name="timeout" value="<?php echo returnontransfer_get('timeout');?>">
            </div>
        </div>
    </div>
    <div class="row">
...
<div class="element-container">
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" id="prefix" name="prefix" value="<?php echo returnontransfer_get('prefix');?>">
            </div>
        </div>
    </div>
    <div class="row">
...
<div class="element-container">
    <div class="row">
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" id="alertinfo" name="alertinfo" value="<?php echo returnontransfer_get('alertinfo');?>">
            </div>
        </div>
    </div>
    <div class="row">
